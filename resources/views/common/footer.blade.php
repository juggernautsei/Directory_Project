            ...
            <div class="col-lg-4 col-md-12">
                <div class="footer_item">
                    ...
                    <a href="{{ URL::to('/') }}" class="footer_logo mb-3 d-inline-block" title="logo">
                      @if(getcong('site_footer_logo'))
                        <img src="{{ URL::asset('upload/'.getcong('site_footer_logo')) }}" alt="logo" style="max-width: 200px;" title="footer logo">
                      @else
                        <img src="{{ URL::asset('assets/images/logo_dark.png') }}" alt="logo" style="max-width: 200px;" title="footer logo">
                      @endif
                    </a>
