                    ...
                    <div class="sidebar-content">
                        ...
                        <div class="side-content">
                            <ul class="nav-main">
                                ...
                                <li><a class="{{classActivePath('categories')}}" href="{{ URL::to('admin/categories') }}"><i class="fa fa-bars"></i>{{trans('words.categories')}}</a></li>
                                <li><a class="{{classActivePath('subcategories')}}" href="{{ URL::to('admin/subcategories') }}"><i class="fa fa-list-ul"></i>{{trans('words.sub_categories')}}</a></li>
                                ...
                                <li><a class="{{classActivePath('listings')}}" href="{{ URL::to('admin/listings') }}"><i class="fa fa-map-marker"></i>{{trans('words.listings')}}</a></li>
