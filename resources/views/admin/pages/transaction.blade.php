                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            ...
                            <div class="col-lg-5 col-md-6" style="padding-left:0;display: flex;">
                                {!! Form::open(array('url' => 'admin/transaction','class'=>'','id'=>'search','role'=>'form','method'=>'get')) !!}  
                                            <input type="text" class="span8 form-control" name="s" placeholder="{{trans('words.search_by_payment_id_email')}}" style="float: left;display: inline;width: 68%;">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>                                         
                                        ...
                                        <td>{!!getcong('currency_symbol')!!}{{$trans->payment_amount}}</td>
