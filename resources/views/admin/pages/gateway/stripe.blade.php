                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-12">
                            ...
                            <span aria-hidden="true">&times;</span></button>
                                ...
                                {!! Form::open(array('url' => array('admin/payment_gateway/stripe'),'class'=>'form-horizontal padding-15','name'=>'category_form','id'=>'category_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Stripe Secret Key</label>
                                          <div class="col-sm-9">
                                            <input type="text" name="stripe_secret_key" value="{{ isset($gateway_info->stripe_secret_key) ? $gateway_info->stripe_secret_key : null }}" class="form-control">
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Stripe Publishable Key</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="stripe_publishable_key" value="{{ isset($gateway_info->stripe_publishable_key) ? $gateway_info->stripe_publishable_key : null }}" class="form-control">
                                        </div>
                                    </div>
