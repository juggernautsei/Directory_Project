                    ...
                    <div class="block">
                        <div class="block-header" style="padding-bottom: 0;">  
                            ...
                            <div class="col-lg-4 col-md-6" style="padding-left:0;display: flex;">
                                {!! Form::open(array('url' => 'admin/listings','class'=>'','id'=>'search','role'=>'form','method'=>'get')) !!}  
                                            <input type="text" class="span8 form-control" name="s" placeholder="{{trans('words.search_by_title_address')}}" style="float: left;display: inline;width: 70%;">
