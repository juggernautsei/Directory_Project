            ...
            <div class="row">
                ...
                <span aria-hidden="true">&times;</span></button>
                            ...
                            <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                ...
                                {!! Form::open(array('url' => 'admin/login','class'=>'js-validation-login form-horizontal push-20-t push-20','id'=>'loginform','role'=>'form')) !!}
                                ...
                                <div class="col-md-12" style="margin-bottom:15px;">                                     
                                    <label class="css-input switch switch-sm switch-primary">
                                        <input type="checkbox" id="login-remember-me" name="remember"><span></span> {{trans('words.remember_me')}}
                                    </label>                                     
                                </div>
                                <div class="col-md-12" style="margin-bottom:15px;">
