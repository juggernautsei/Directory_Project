...
<section class="breadcrumb-area" style="background-image:url({{URL::to('assets/images/bread-bg.jpg')}})">
    ...
    <div class="container">
        <div class="breadcrumb-content">
            <h2 class="item_sec_title text-white">{{trans('words.login')}}</h2>
            <ul class="bread-list">
                <li><a href="{{URL::to('/')}}">{{trans('words.home')}}</a></li>
                <li>{{trans('words.login')}}</li>
            </ul>
        </div>
    </div>    
</section>
            ...
            {!! Form::open(array('url' => 'login','class'=>'card mb-0','id'=>'login','role'=>'form')) !!}     
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form--control pl-3" type="text" name="email" placeholder="{{trans('words.email')}}">
                    </div>
                    <div class="form-group">
