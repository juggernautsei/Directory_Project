               ...
               <div class="row">
                   <div class="col-lg-6 col-md-6">
                       ...
                       <div class="form-group">
                           <input class="form-control form--control" type="text" name="first_name" value="{{$user->first_name}}" required>
                       </div>
                   </div>
                   <div class="col-lg-6 col-md-6">
                       <label class="label-text">{{trans('words.last_name')}}</label>
                       <div class="form-group">
                           <input class="form-control form--control" type="text" name="last_name" value="{{$user->last_name}}" required>
                       </div>
                   </div>
                   <div class="col-lg-6 col-md-6">
                       <label class="label-text">{{trans('words.email')}}</label>
                       <div class="form-group">
                           <input class="form-control form--control" type="text" name="email" value="{{$user->email}}" required>
                       </div>
                   </div>
                   <div class="col-lg-6 col-md-6">
                   ...
                   <div class="col-lg-6 col-md-6">
                       ...
                       <div class="form-group">
                           <input class="form-control form--control" type="text" name="contact_email" value="{{$user->contact_email}}" placeholder="">
                       </div>
                   </div> 
                   <div class="col-lg-6 col-md-6">
                       <label class="label-text">{{trans('words.website')}}</label>
                       <div class="form-group">
                           <input class="form-control form--control" type="text" name="website" value="{{$user->website}}" placeholder="www.website.com">
                       </div>
                   </div>
                   <div class="col-lg-6 col-md-6">
                       <label class="label-text">Facebook</label>
                       <div class="form-group">
                           <input class="form-control form--control" type="text" name="facebook_url" value="{{$user->facebook_url}}" placeholder="">
                       </div>
                   </div>
                   <div class="col-lg-6 col-md-6">
                       <label class="label-text">Twitter</label>
                       <div class="form-group">
                           <input class="form-control form--control" type="text" name="twitter_url" value="{{$user->twitter_url}}" placeholder="">
                       </div>
                   </div>
                   <div class="col-lg-6 col-md-6">
                       <label class="label-text">Instagram</label>
                       <div class="form-group">
                           <input class="form-control form--control" type="text" name="instagram_url" value="{{$user->instagram_url}}" placeholder="">
                       </div>
                   </div>
                   <div class="col-lg-6 col-md-6">
                       <label class="label-text">Linkedin</label>
                       <div class="form-group">
                           <input class="form-control form--control" type="text" name="linkedin_url" value="{{$user->linkedin_url}}" placeholder="">
                       </div>
                   </div>
                   <div class="col-lg-12">
