                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control form--control pl-3" type="text" name="title" id="title" value="{{ isset($listing->title) ? $listing->title : null }}" placeholder="e.g. Super duper burger">
                            </div> 
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <option value="1" @if(isset($listing->featured_listing) AND $listing->featured_listing==1) selected @endif>Featured</option>
                                  <option value="0" @if(isset($listing->featured_listing) AND $listing->featured_listing==0) selected @endif>None Featured</option>  
                                </select>
                            </div>
                        </div> 
                        @endif                        
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" class="form-control form--control pl-3 user-text-editor elm1_editor" rows="5">{{ isset($listing->description) ? $listing->description : null }}</textarea>
                            </div>
                        </div>
                           ...
                           <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control form--control pl-3" type="text" name="address" id="address" placeholder="{{trans('words.address')}}" value="{{ isset($listing->address) ? $listing->address : null }}">
                                </div>
                            </div>
                                  ...
                                  <select id="location" name="location" class="select-picker" data-width="100%" data-size="5" data-live-search="true">
                                      <option value="">{{trans('words.select_location')}}</option>
                                        @foreach($locations as $i => $location) 
                                          @if(isset($listing->location_id) && $listing->location_id==$location->id)  
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="google_map_code" id="google_map_code" class="form-control form--control pl-3 user-text-editor" rows="3">{{ isset($listing->google_map_code) ? $listing->google_map_code : null }}</textarea>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="amenities-wrap mt-4">
						<div class="form-group">
						   <input id="amenities_tags" type="text" name="amenities" class="form-control form--control pl-3" value="{{ isset($listing->amenities) ? $listing->amenities : '' }}" />
						</div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="working_hours_mon" type="text" name="working_hours_mon" class="form-control form--control pl-3" value="{{ isset($listing->working_hours_mon) ? $listing->working_hours_mon : null }}" placeholder="9am - 5pm" />
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="working_hours_tue" type="text" name="working_hours_tue" class="form-control form--control pl-3" value="{{ isset($listing->working_hours_tue) ? $listing->working_hours_tue : null }}" placeholder="9am - 5pm"/>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="working_hours_wed" type="text" name="working_hours_wed" class="form-control form--control pl-3" value="{{ isset($listing->working_hours_wed) ? $listing->working_hours_wed : null }}" placeholder="9am - 5pm"/>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="working_hours_thurs" type="text" name="working_hours_thurs" class="form-control form--control pl-3" value="{{ isset($listing->working_hours_thurs) ? $listing->working_hours_thurs : null }}" placeholder="9am - 5pm"/>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="working_hours_fri" type="text" name="working_hours_fri" class="form-control form--control pl-3" value="{{ isset($listing->working_hours_fri) ? $listing->working_hours_fri : null }}" placeholder="9am - 5pm"/>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="working_hours_sat" type="text" name="working_hours_sat" class="form-control form--control pl-3" value="{{ isset($listing->working_hours_sat) ? $listing->working_hours_sat : null }}" placeholder="9am - 5pm"/>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input id="working_hours_sun" type="text" name="working_hours_sun" class="form-control form--control pl-3" value="{{ isset($listing->working_hours_sun) ? $listing->working_hours_sun : null }}" placeholder="Closed"/>
                            </div>
                        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="video" id="video" class="form-control form--control pl-3 user-text-editor" rows="3">{{ isset($listing->video) ? $listing->video : null }}</textarea>
