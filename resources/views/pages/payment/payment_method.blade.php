...
<div class="modal fade modal-container" id="phone_update" tabindex="-1" role="dialog" aria-labelledby="phone_update" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(array('url' => 'phone_update','class'=>'row"','name'=>'phone_update','id'=>'phone_update','role'=>'form','enctype' => 'multipart/form-data')) !!}  
              <input name="" value="" type="hidden">
              
              <div class="col-lg-12 col-md-12">
                       <label class="label-text">{{trans('words.phone')}}</label>
                       <div class="form-group">
                           <input class="form-control form--control" type="number" name="phone" value="" placeholder="" required>
                       </div>
              </div>               
